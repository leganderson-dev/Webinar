...
[Description_new] [varchar] (max) COLLATE Latin1_General_CI_AS NULL,
...
GO
EXEC sp_addextendedproperty N'MS_Description', N'A short description of the article going between the title and "read more"', 'SCHEMA', N'dbo', 'TABLE', N'Articles', 'COLUMN', N'Description_new'
GO
